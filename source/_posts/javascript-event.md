...
![Paste_Image.png](http://upload-images.jianshu.io/upload_images/68937-ad288388904dac46.png)

### 2、事件捕获

事件捕获跟事件冒泡恰好相反。它的思想是不太具体的节点应该更早接收到事件，而最具体的节点最后接收到事件。

![Paste_Image.png](http://upload-images.jianshu.io/upload_images/68937-320530fe2540a3e9.png)

### 3、事件的三个阶段

事件的三个阶段分别是：捕获阶段、目标阶段、冒泡阶段

![事件的三个阶段](http://upload-images.jianshu.io/upload_images/68937-b94c4415d8c290f0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![Paste_Image.png](http://upload-images.jianshu.io/upload_images/68937-477214596bb6ec09.png)
