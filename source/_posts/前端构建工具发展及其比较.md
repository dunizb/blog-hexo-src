...
---
![Rollup](//www.rollupjs.com/assets/images/twitter-card.jpg)
...
[Rollup](//www.rollupjs.com/) 是一个和 Webpack 很类似但专注于ES6的模块打包工具。它的亮点在于，针对ES6源码进行 Tree Shaking,以去除那些已经被定义但没被使用的代码并进行 Scope Hoisting，以减少输出文件的大小和提升运行性能。然而 Rollup 的这些亮点随后就被 Webpack 模仿和实现了。由于 Rollup 的使用方法和 Webpakc 差不多，所以这里就不详细介绍如何使用 Rollup 了，而是详细说明他们的差别：
...
与Webpack的详细对比请参看[这里](//www.cnblogs.com/lxg0/p/8387670.html)
