...
CSS中的间距有两种类型，一种在元素外部，另一种在元素内部。对于本文，我将其称为**outer**和**inner**。假设我们有一个元素，它内部的间距是**inner**，外部的间距是**outer**。
...
如果您想更多地挖负margin，建议阅读[这篇](https://www.quirksmode.org/blog/archives/2020/02/negative_margin.html)文章。
...
通常，我更喜欢将组件封装起来，并避免给它们增加边距。由于这个原因，我有 `grid__item`元素，我的card组件将位于其中。
...
我在检查[Facebook的新设计CSS](https://ishadeed.com/article/new-facebook-css/)时首先注意到了这一点。
