...
<!-- more -->
![](https://gitee.com/dunizb/cloudimg/raw/jsdelivr/weapp-timeline/banner.jpg)
...
![Timeline 组件的文档](https://gitee.com/dunizb/cloudimg/raw/jsdelivr/weapp-timeline/1.png)
...
```html
<!-- timeline/index.wxml -->
<view class="pps-timeline custom-class {{reverse?'desc':'asc'}}">
  <slot />
</view>
```
...
<img src="https://gitee.com/dunizb/cloudimg/raw/jsdelivr/weapp-timeline/2.png" alt="DOM结构" style="width:320px" />
...
## 推荐几个优秀的组件库
- [iView Weapp](https://weapp.iviewui.com)。出自著名的Vue组件库 iView 之家，跟 iView 一脉相承。
